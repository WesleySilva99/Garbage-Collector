	...
	<form class="form-inline" action="cadastrarUsuario" method="post">
		...
		<div class="form-group">
			<label for="exampleInputData">Data de Nascimento:</label> <input
				...
				maxlength="10" min="01/01/1943" max="31/12/2008">
		</div>
		<br><br>
		...
		<div class="form-group">
			<label for="exampleInputTelefone">Telefone:</label> <input
				...
				placeholder="(00) 00000-0000" required="Para realizar o cadastro preencha este campo com o endereço da sua rua" maxlength="15"
		...
		<div class="form-group">
			<label for="exampleInputEmail">E-mail:</label> <input type="email"
				...
				placeholder="João@exemplo.com" required="Para realizar o cadastro preencha este campo com o seu email"
		...
		<div class="form-group">
			<label for="exampleInputPassword1">Senha:</label> <input
				...
				required="Para realizar o cadastro preencha este campo com sua senha" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
		...
		<div class="form-group">
			<label for="exampleInputPassword1">Repita sua senha:</label> <input
				type="password" class="form-control" id="exampleInputPassword1"
				required="Para realizar o cadastro preencha este campo repetindo novamente sua senha" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
				maxlength="30" title="A senha deve ser igual a da campo anterior.">
		</div>
		<br><br>
